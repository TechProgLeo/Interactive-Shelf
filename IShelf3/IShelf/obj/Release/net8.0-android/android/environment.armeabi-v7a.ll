...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1437191859, ; hash 0x55a9ceb3, from name: libaot-IShelf.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1840066752, ; hash 0x6dad30c0, from name: IShelf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 194
	...
	%struct.DSOCacheEntry {
		i64 2718735771, ; hash 0xa20c9d9b, from name: libaot-IShelf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 304
	...
	%struct.DSOCacheEntry {
		i64 3002286386, ; hash 0xb2f34132, from name: aot-IShelf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 343
	...
	%struct.DSOCacheEntry {
		i64 3138425317, ; hash 0xbb1091e5, from name: IShelf.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 4210058576, ; hash 0xfaf06550, from name: aot-IShelf.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
