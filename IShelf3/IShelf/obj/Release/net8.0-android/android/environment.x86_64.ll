...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 561525348845591310, ; hash 0x7caf05466519b0e, from name: aot-IShelf.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 14
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1430659197304949155, ; hash 0x13dab8f5c201c9a3, from name: IShelf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 34
	...
	%struct.DSOCacheEntry {
		i64 3623382030612702472, ; hash 0x3248d6c264342508, from name: IShelf.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 94
	...
	%struct.DSOCacheEntry {
		i64 5720019989418501587, ; hash 0x4f6197dfd96c65d3, from name: libaot-IShelf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 8180353657015593278, ; hash 0x7186744f477b693e, from name: libaot-IShelf.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	...
	%struct.DSOCacheEntry {
		i64 13154923927456301648, ; hash 0xb68fad9d3f51c250, from name: aot-IShelf
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-IShelf.dll.so
		ptr null; void* handle (0x0)
	}, ; 341
...
@.env.3 = private unnamed_addr constant [37 x i8] c"9116fea4-a0e7-4910-aaa8-a8373b39da28\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [23 x i8] c"com.companyname.ishelf\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [21 x i8] c"libaot-IShelf.dll.so\00", align 16
